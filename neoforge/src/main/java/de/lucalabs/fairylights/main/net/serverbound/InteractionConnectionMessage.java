...
/**
 * NeoForge handler for the serverbound connection-interaction payload. Mirrors the Fabric
 * {@code InteractionConnectionMessage}; only the entry point differs (NeoForge IPayloadContext
 * supplies the ServerPlayer instead of Fabric's networking context).
 */
public final class InteractionConnectionMessage {
    ...
    private InteractionConnectionMessage() {
    }

    public static void apply(final InteractionConnectionMessagePayload payload, final ServerPlayer player) {
