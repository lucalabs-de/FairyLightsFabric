...
public final class FairyLightItems {
    ...
    public static final LightItem FAIRY_LIGHT = register("fairy_light", createColorLight(FLBlocks.FAIRY_LIGHT));
    public static final LightItem PAPER_LANTERN = register("paper_lantern", createColorLight(FLBlocks.PAPER_LANTERN));
    public static final LightItem INCANDESCENT_LIGHT = register("incandescent_light", createLight(FLBlocks.INCANDESCENT_LIGHT, LightItem::new));
    ...
    private static Supplier<LightItem> createLight(final LightBlock block, final BiFunction<LightBlock, Item.Settings, LightItem> factory) {
