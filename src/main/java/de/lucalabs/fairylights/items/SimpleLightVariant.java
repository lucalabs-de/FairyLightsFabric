...
public class SimpleLightVariant<T extends LightBehavior> extends LightVariant<T> {
    ...
    public static final LightVariant<StandardLightBehavior> ORB_LANTERN = new SimpleLightVariant<>(
            false,
            1.0F,
    ...
    public static final LightVariant<StandardLightBehavior> FLOWER_LIGHT = new SimpleLightVariant<>(
            true,
            1.0F,
    ...
    public static final LightVariant<StandardLightBehavior> CANDLE_LANTERN_LIGHT = new SimpleLightVariant<>(
            false,
            1.5F,
    ...
    public static final LightVariant<StandardLightBehavior> JACK_O_LANTERN = new SimpleLightVariant<>(
            true,
            1.0F,
    ...
    public static final LightVariant<StandardLightBehavior> SKULL_LIGHT = new SimpleLightVariant<>(
            true,
            1.0F,
            new Box(-0.200D, -0.404D, -0.200D, 0.200D, 0.122D, 0.200D), 0.044D,
            SimpleLightVariant::standardBehavior);

    public static final LightVariant<StandardLightBehavior> GHOST_LIGHT = new SimpleLightVariant<>(
            true,
            1.0F,
            new Box(-0.270D, -0.390D, -0.270D, 0.270D, 0.169D, 0.270D), 0.075D,
            SimpleLightVariant::standardBehavior);

    public static final LightVariant<StandardLightBehavior> SPIDER_LIGHT = new SimpleLightVariant<>(
            true,
            1.0F,
    ...
    public static final LightVariant<StandardLightBehavior> WITCH_LIGHT = new SimpleLightVariant<>(
            true,
            1.0F,
    ...
    public static final LightVariant<StandardLightBehavior> SNOWFLAKE_LIGHT = new SimpleLightVariant<>(
            true,
            1.0F,
    ...
    public static final LightVariant<StandardLightBehavior> HEART_LIGHT = new SimpleLightVariant<>(
            true,
            1.0F,
    ...
    public static final LightVariant<StandardLightBehavior> MOON_LIGHT = new SimpleLightVariant<>(
            true,
            1.0F,
    ...
    public static final LightVariant<StandardLightBehavior> STAR_LIGHT = new SimpleLightVariant<>(
            true,
            1.0F,
            new Box(-0.200D, -0.669D, -0.144D, 0.300D, 0.063D, 0.144D),
            0.044D,
    ...
    public static final LightVariant<MultiLightBehavior> ICICLE_LIGHTS = new SimpleLightVariant<>(
            false,
            0.625F,
            new Box(-0.264D, -1.032D, -0.253D, 0.276D, 0.091D, 0.266D), 0.012D,
            stack -> MultiLightBehavior.create(4, () -> standardBehavior(stack)));

    public static final LightVariant<MeteorLightBehavior> METEOR_LIGHT = new SimpleLightVariant<>(
            false,
            1.5F,
    ...
    public static final LightVariant<BrightnessLightBehavior> CANDLE_LANTERN = new SimpleLightVariant<>(
            false,
