...
public class FairyLightComponents implements EntityComponentInitializer, BlockComponentInitializer {
    ...
    public static final ComponentType<LightVariantComponent.Data> LIGHT_VARIANT = ComponentType.<LightVariantComponent.Data>builder()
            .codec(LightVariantComponent.Data.CODEC)
            .packetCodec(LightVariantComponent.Data.PACKET_CODEC)
            .build();
