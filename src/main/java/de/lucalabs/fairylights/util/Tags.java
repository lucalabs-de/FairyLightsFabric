...
public final class Tags {
    ...
    public static final TagKey<Item> LIGHTS = TagKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath(FairyLights.ID, "lights"));
    public static final TagKey<Item> TWINKLING_LIGHTS = TagKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath(FairyLights.ID, "twinkling_lights"));
    public static final TagKey<Item> PENNANTS = TagKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath(FairyLights.ID, "pennants"));
    public static final TagKey<Item> DYEABLE = TagKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath(FairyLights.ID, "dyeable"));
    public static final TagKey<Item> DYEABLE_LIGHTS = TagKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath(FairyLights.ID, "dyeable_lights"));
